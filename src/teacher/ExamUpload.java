...
@WebServlet("/ExamUpload")
public class ExamUpload extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.print("<script>alert('上传文件过大或过小!'); window.location.href='/exam/teacher/add_exam.jsp'</script>");
		}
