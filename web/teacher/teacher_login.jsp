...
<div class="container">
		<div class="row panel panel-default center" style="background-color: rgba(220,220,220,0.7);">
		<h3><b>登录到在线考试系统</b></h3>
		<br/>
			<form class="form-horizontal" role="form" action="./TeacherLogin">
			<div class="col-xs-offset-1 col-xs-10 input-group">
          		<span class="input-group-addon">
           			<span class="glyphicon glyphicon-user"></span>
          		</span>
          		<input type="text" class="input-lg form-control input-font-size" name="t_id" 
